...
const Bannertitle = ({title,overview}) => {
  return (
    <div className="absolute h-[100%] pt-[20vw] pl-[5vw] w-screen bg-gradient-to-r from-zinc-900 aspect-video">
      <h1 className="text-white text-[3.5vw] inline-block leading-tight overflow-hidden">{title}</h1>
      <p className="text-white text-[1.2vw] w-[40%] py-4 leading-tight">{overview}</p>
