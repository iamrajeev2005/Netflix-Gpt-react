...
const Login = () => {
  ...
  return (
    <>
      <div className="min-h-[100vh] w-screen relative bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/c38a2d52-138e-48a3-ab68-36787ece46b3/eeb03fc9-99c6-438e-824d-32917ce55783/IN-en-20240101-popsignuptwoweeks-perspective_alpha_website_medium.jpg')] bg-no-repeat bg-cover bg-center">
        <div className="bg-black absolute h-[100vh] w-screen opacity-65"></div>
        <div className="relative py-6 px-10">
          <div
            onClick={goToHome}
            className="h-[3.5vw] w-[13vw] cursor-pointer "
          >
            <svg
              viewBox="0 0 120 30"
              version="1.1"
